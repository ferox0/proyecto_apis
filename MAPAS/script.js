...
function traerCapitales() {
    ...
    .then(data => {
        ...
        contenido.innerHTML = `
        <div style="display: block; margin: left;">
        
         <img style="display: block; margin: left; height: 100px;" src="${data[0].flag}" class="img-fluid rounded-circle"> 
        <p style="text-align: left;">Pais 🌎: ${data[0].name}  <br>
            Capital 🏙: ${ciudad} <br>
